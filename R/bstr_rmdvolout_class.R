              ...
              public = list(
                ...
                save_out = function(bstr_data, bstr_model, outdir, voxelcoord) {
                  ...
                  for(cluster_iter in 1:length(voxelcoord)) {
                    ...
                    render_atlas(cluster_iter, voxelcoord,
                                         atlaspath = bstr_data@atlas_filename,
                                         outdir)
                    # }

                    render_html(bstr_data,
                                        bstr_model,
                                        outdir,
                                        voxelcoord,
                  ...
                  save_rmd_preamble(bstr_data, bstr_model, file.path(outdir,  sprintf("report_%s_%s.Rmd", bstr_model@model_type, switch(bstr_model@model_type,
